namespace SmpsPortal.Migrations
{
    ...
    public partial class DBRefreshed : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.GradeLevels", t => t.GradeLevelId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Assessments", t => t.AssessmentId, cascadeDelete: false)
                .ForeignKey("dbo.AspNetUsers", t => t.StudentId)
                .Index(t => t.StudentId)
                .Index(t => t.AssessmentId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Courses", t => t.CourseId, cascadeDelete: false)
                .ForeignKey("dbo.GradeSystems", t => t.GradeSystemId, cascadeDelete: false)
                .ForeignKey("dbo.SchoolClasses", t => t.SchoolClassId, cascadeDelete: false)
                .ForeignKey("dbo.AspNetUsers", t => t.StudentId)
                .ForeignKey("dbo.YearTerms", t => t.YearTermId, cascadeDelete: false)
                .Index(t => t.StudentId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.YearTerms", t => t.CurrentYearTermId, cascadeDelete: false)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MenuComponents", "MenuId", "dbo.MenuComponents");
            ...
            DropIndex("dbo.MenuComponents", new[] { "MenuId" });
